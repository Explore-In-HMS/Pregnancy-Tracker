...
public class MLFaceGraphic extends GraphicOverlay.Graphic {
    ...
    private final IMoodChangeListener moodChangeListener;
    ...
    private  MLFace mFace;

    public MLFaceGraphic(GraphicOverlay overlay, MLFace face, IMoodChangeListener moodChangeListener) {
        super(overlay);

        mFace = face;
        this.overlay = overlay;
        this.moodChangeListener = moodChangeListener;
    ...
    public void draw(Canvas canvas) {
        ...
        if (moodChangeListener != null) {
            moodChangeListener.onMoodChange(EMood.valueOf(result.get(0).toUpperCase(Locale.US)));
        }
