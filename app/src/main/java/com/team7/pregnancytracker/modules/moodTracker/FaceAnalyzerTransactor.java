...
public class FaceAnalyzerTransactor implements MLAnalyzer.MLTransactor<MLFace> {
    ...
    private IMoodChangeListener moodChangeListener;

    FaceAnalyzerTransactor(GraphicOverlay ocrGraphicOverlay, IMoodChangeListener moodChangeListener) {
    ...
    public void transactResult(MLAnalyzer.Result<MLFace> result) {
        ...
        for (int i = 0; i < faceSparseArray.size(); i++) {
            ...
            MLFaceGraphic graphic = new MLFaceGraphic(this.mGraphicOverlay, faceSparseArray.valueAt(i), moodChangeListener);
